...
<br />
Per non coprire il gusto degli asparagi, non ho usato il sugo al pomodoro, ma la besciamella. Però ho aggiunto ugualmente qualche pomodorino fresco per dare un pò di freschezza e le uova sode, perché le uova stanno divinamente con gli asparagi. Ovviamente se non amate particolarmente la lasagna bianca, potete tranquillamente mettere anche il sugo.
      ...
      <table>
        <tbody>
          <tr itemprop="recipeIngredient">
            <td>ca. 300gr</td>
            <td>lasagne secche o fresche (ai spinaci)</td>
          </tr>
          <tr itemprop="recipeIngredient">
            <td>1kg</td>
            <td>asparagi</td>
          ...
          <tr itemprop="recipeIngredient">
            <td>1</td>
            <td>scalogno o cipolla grande</td>
          </tr>
          <tr itemprop="recipeIngredient">
            <td>1l</td>
            <td>latte</td>
...
Tagliate lo scalogno a striscioline fine e mettetelo in una padella con un po' di olio e fatelo rosolare. Nel frattempo staccate la parte dura e legnosa degli asparagi e tagliateli a rondelle, mettetendo da parte le punte. Aggiungete gli asparagi allo scalogno (senza le punte) e fateli ammorbidire con l'aggiunta di un poco d'acqua. Quando gli asparagi si saranno ammorbiditi aggiungete le punte e aggiustate di sale. Fate cucinare ancora per qualche minuto e togliete dal fuoco.
